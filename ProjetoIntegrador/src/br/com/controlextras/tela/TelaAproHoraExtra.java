...
public class TelaAproHoraExtra extends javax.swing.JDialog {

    DefaultTableModel dtmHorasExtras;
    DateTimeFormatter dataFormatada = DateTimeFormatter.ofPattern("dd/MM/yyyy");
    
    public TelaAproHoraExtra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        preencherComboCargo();
        carregaFuncionario();
    ...
    private void initComponents() {
        ...
        String colunas[] = {"ID", "Data", "Começo", "Término", "Criador", "Realizada por"};
        ...
        setTitle("Horas Extras não aprovadas");
        setResizable(false);
        ...
        pnlHoraExtras.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Horas Extras não aprovadas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18), new java.awt.Color(11, 135, 112))); // NOI18N
        ...
        btnAprovar.setForeground(new java.awt.Color(0, 153, 51));
    ...
    private void btnAprovarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAprovarActionPerformed
        ...
        if(resp == -1 ){
            ...
            int idHe = (int) dtmHorasExtras.getValueAt(resp, 0);
            
            HoraExtraDAO heDao = new HoraExtraDAO();
            HoraExtra he = heDao.getHoraExtra(idHe);
            
            FuncHoraExtraDAO funcHeDao = new FuncHoraExtraDAO();
            FuncHoraExtra funcHe = funcHeDao.getFuncHoraExtraIdHoraExtra(idHe);
            
            FuncionarioDAO funcDao = new FuncionarioDAO();
            Funcionario funcionarioHe =  funcDao.getFuncionario(funcHe.getFuncId());
            
            int resposta = mensagemRealizarHE(funcionarioHe, he);
            
            switch (resposta) {
                case 0 -> {
                    heDao.aprovar(true, idHe);
                    atualizaLista();
                }
                case 1 -> {
                    heDao.aprovar(false, idHe);
                    atualizaLista();
                }
                default -> tblHorasExtras.clearSelection();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAproHoraExtra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            TelaAproHoraExtra dialog = new TelaAproHoraExtra(new javax.swing.JFrame(), true);
    ...
    private void filtraLista() {
        ...
        List<HoraExtra> heFiltradas = null;
        
        if((mesFiltrar == 0) && (anoFiltrar == 0)){
            atualizaLista();
        } else if((mesFiltrar != 0) && (anoFiltrar == 0)){
            heFiltradas = listaHe.values().stream()
                .filter(he -> !he.isVerificada())
                .filter(he -> he.isInscrito())
    ...
    private int mensagemRealizarHE(Funcionario funcionario, HoraExtra he) {
        int resp = tblHorasExtras.getSelectedRow();
        Object[] opcoes = {"<html><body><b><span style='color:green;'>SIM</span></b></body></html>", 
                            "<html><body><b><span style='color:red;'>NÃO</span></b></body></html>", 
                             "Cancelar"};
        String criador = (String) dtmHorasExtras.getValueAt(resp, 4);
        String mensagem = "<html><body>" +
                "<span>O funcionário <b>" + funcionario.getNome() + " <span style='color:blue;'>realizou</span> a hora extra</b> abaixo? </span><br>" +
                ...
                "<b><span>Criada por: </span></b>" + criador + "<br>" +
                "<b>Observação:</b>"+ he.getObservacao() + "</span>" +
                "</body></html>";
                
        int resposta = JOptionPane.showOptionDialog(null, mensagem, 
            "Foi realizado essa hora extra?", JOptionPane.DEFAULT_OPTION, 
    ...
    void montaTabela(List<HoraExtra> datasFiltradas) {
        for (HoraExtra he : datasFiltradas) {
            ...
            FuncHoraExtra fhe = fheDao.getFuncHoraExtraIdHoraExtra(he.getId());

            Funcionario func = funcDao.getFuncionario(fhe.getFuncId());
            Object[] linha = {he.getId(), he.getData().format(dataFormatada), 
                                he.getHoraInicio(), he.getHoraFim(),
                                nomeSobrenome(funCriador.getNome()), nomeSobrenome(func.getNome())};
    ...
    private void atualizaLista() {
        ...
        List<HoraExtra> listaNaoVerificados = listaHoraExtra.values().stream()
                                            .filter(h -> !h.isVerificada())
                                            .filter(h -> h.isInscrito())
                                            .sorted(Comparator.comparingInt(HoraExtra::getId).reversed()) // Ordena pela data
                                            .collect(Collectors.toList()
        );
        
        montaTabela(listaNaoVerificados);
    }
